# Legacy v1 Pet Workflow

Use only after the entrypoint confirms explicit v1 compatibility work. Paths and scripts in this retained workflow resolve from the hatch-pet skill root, not this references directory. It is not the contract for new v2 pets.
