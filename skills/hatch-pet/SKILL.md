---
name: hatch-pet
description: Create, repair, validate, visually QA, and package Codex-compatible animated pets. Use for branded mascots, custom non-pixel styles, 8x9 spritesheet atlases, contact-sheet QA, and pet.json packaging; combines imagegen with deterministic assembly scripts.
---
