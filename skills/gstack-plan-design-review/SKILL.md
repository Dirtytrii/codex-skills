...
description: GStack design plan review for user journey, layout, interaction model, responsive behavior, accessibility, and visual risk before UI work starts.
---

# GStack Design Plan Review Adapter

This is a Codex role-system adapter for Garry Tan's gstack `gstack-plan-design-review` method.

## When To Use

Use this when:

- a plan includes UI, UX, landing, deck, or visual artifacts;
- architecture needs to define UI/PPT boundaries;
- responsive or accessibility constraints are unclear;
- the user explicitly invokes `$gstack-plan-design-review`.
...
4. Produce: design risks, visual constraints, acceptance checks, and UI/PPT prompt refinements.
