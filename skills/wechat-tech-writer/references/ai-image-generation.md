...
python scripts/generate_image.py \
  --prompt "图片描述提示词" \
  --api gemini \
  --output outputs/images/cover.png
...
# 检查图片是否生成成功
if os.path.exists('outputs/images/cover.png'):
    print("✅ 封面图生成成功")
```
...
images_to_generate = [
    ...
    },
    {
        "type": "concept",
        "prompt": "概念图提示词",
        "output": "outputs/images/concept.png"
    },
    {
        "type": "scene",
        "prompt": "场景图提示词",
        "output": "outputs/images/scene.png"
    }
]
...
import shutil
for img in images_to_generate:
    shutil.copy(img['output'], 'outputs/')
```
