...
description: GStack document generation method for turning implementation, product, or operational work into durable docs with clear audience and ownership.
---
...
This is a Codex role-system adapter for Garry Tan's gstack `gstack-document-generate` method.

## When To Use

Use this when:

- work should become durable docs;
- architecture wants docs as acceptance;
- a release or feature lacks user/internal documentation;
- the user explicitly invokes `$gstack-document-generate`.
...
4. Produce: target docs, audience, outline, content changes, and validation notes.
