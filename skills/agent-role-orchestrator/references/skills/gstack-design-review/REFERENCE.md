...
description: GStack design-review method for reviewing rendered UI, landing pages, decks, or visual artifacts for hierarchy, layout, accessibility, and polish.
---
...
# GStack Design Review Adapter

This is a Codex role-system adapter for Garry Tan's gstack `gstack-design-review` method.

## When To Use

Use this when:

- a rendered UI, deck, or visual asset needs critique;
- QA needs visual readiness evidence;
- visual polish or hierarchy is questionable;
- the user explicitly invokes `$gstack-design-review`.
...
4. Produce: visual findings, severity, screenshots/check notes, recommended fixes, and verification criteria.
