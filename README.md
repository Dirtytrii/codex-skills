...
| UI、网页 PPT、社交卡 | `UI/PPT` + [`ui-implementation-workflow`](skills/ui-implementation-workflow/SKILL.md)：完整参考站目录、最多三份激活参考、预览图实现路线选择、设计规则/Token、骨架优先和 1440/768/390 截图闭环；效果不满意时按失败维度动态换源并保留台账 |
