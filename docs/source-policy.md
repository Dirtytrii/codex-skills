...
- `公众号发布`: `wechat-ai-app-ops` 承接公众号 AI 应用文章、周刊连续性、草稿箱 API 和本地交接；视觉资产可复用 `guizang-social-card-skill`
- `小红书`: 预留的小红书/Rednote 笔记和授权发布角色；图文资产可复用 `guizang-social-card-skill`
